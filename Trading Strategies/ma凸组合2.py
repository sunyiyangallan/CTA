...
#wsd_data=w.wsi("T1803.CFE", "open,high,low,close,chg", "2017-10-11", end_date, "Fill=Previous","BarSize=5")  
    ...
    if (i == fm.shape[0]-1):  # 最后一天 强制平仓
        ...
        if fm.at[i,'pos'] != fm.at[i-1, 'pos']:
            ...
            if fm.at[i,'pos'] == 1:  # 买入
                ...
                if (fm.at[i-1,'hold_num'] == 1):  #之前没有平仓
                    
                    fm.at[i,'hold_num'] = 1
                    
                    cost_value = fm.at[i,'ma_short']
                ...
                #卖出时判断, 价格小于成本价 卖出
                if(fm.at[i,'ma_short'] < cost_value):
